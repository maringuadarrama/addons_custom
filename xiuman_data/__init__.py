...
def _pre_init_xiuman(env):
    ...
    tools.convert.convert_file(env, "xiuman_data", "data/account_account_data.xml", None, mode="init", kind="data")
    tools.convert.convert_file(
        env, "xiuman_data", "data/account_journal_group_data.xml", None, mode="init", kind="data"
    )
    tools.convert.convert_file(env, "xiuman_data", "data/account_journal_data.xml", None, mode="init", kind="data")
