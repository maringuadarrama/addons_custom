...
class TestPoSStock(TestPoSCommon):
    ...
    def setUpClass(cls):
        ...
        cls.env.user.groups_id = [(4, cls.env.ref("xiuman.group_stock_inventory_adjustment").id)]
    ...
    def test_03_error_validate_quant(self):
        self.env.user.groups_id = [(3, self.env.ref("xiuman.group_stock_inventory_adjustment").id)]
        ...
        self.env.user.groups_id = [(4, self.env.ref("xiuman.group_stock_inventory_adjustment").id)]
        quant.action_apply_inventory()
