...
import {WebThreeDCompiler} from "./web_threed_compiler";
import {Component, onWillStart, onWillUpdateProps, useState, useEffect, useRef} from "@odoo/owl";
...
export class ThreedController extends Component {
    setup() {
        ...
        this.templates = useViewCompiler(WebThreeDCompiler, templateDocs);

        this.state = useState({
            groundAreas: [],
            selectedGroundAreaId: undefined,
            showLegend: false,
            showAutoRefreshCountdown: this.props.archInfo.autoRefresh && this.props.archInfo.autoRefresh > 5,
                ...
                () => {
                    this.autoUpdateInterval = setInterval(async () => {
                        ...
                        if (this.state.autoRefreshCountdown <= 0) {
                            ...
                            this.state.autoRefreshCountdown = this.props.archInfo.autoRefresh;
                        }
                    }, 1000);
